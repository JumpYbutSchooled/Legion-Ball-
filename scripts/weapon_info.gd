...
## white weapons. Pool weapons marked "built": false are concepts shown in the Armory but
## not playable yet.
...
const WEAPONS := {
	...
	# FROST / CONTROL
	"frost_lance": {"name": "FROST LANCE", "tag": "CHILLING BEAM", "group": "frost",
	...
	"gravity_well": {"name": "GRAVITY WELL", "tag": "SINGULARITY", "group": "frost",
	...
	"prism_cage": {"name": "PRISM CAGE", "tag": "CRYSTAL TRAP", "group": "frost",
		"color": Color(0.3, 1.0, 0.85), "layout": "Four blades meeting in a box frame in front.",
		"summary": "A slow orb that locks the first player it hits in a breakable crystal cage (2s).",
		"combo": "Cage them, then EXECUTIONER."},
	"stasis_mine": {"name": "STASIS MINE", "tag": "PROXIMITY TRAP", "group": "frost",
	...
	"time_dilator": {"name": "TIME DILATOR", "tag": "SLOW FIELD", "group": "frost",
	...
	# HUNTER / MARK
	"hunters_sigil": {"name": "HUNTER'S SIGIL", "tag": "TRACKER", "group": "hunter",
	...
	"executioner": {"name": "EXECUTIONER", "tag": "FINISHER", "group": "hunter",
	...
	"echo_rifle": {"name": "ECHO RIFLE", "tag": "DOUBLE TAP", "group": "hunter",
	...
	"splinter_bomb": {"name": "SPLINTER BOMB", "tag": "STICKY CHARGE", "group": "hunter",
	...
	# SKYBORNE / MOBILITY
	"blink_edge": {"name": "BLINK EDGE", "tag": "TELEPORT SLASH", "group": "skyborne",
		"color": Color(0.2, 1.0, 0.6), "layout": "Two thin swept blades along the sides, pointing back.",
		"summary": "Teleport 15m where you look, leaving a slash that cuts anyone on the line.",
		"combo": "Blink in, SCATTER, blink out."},
	"jet_crystals": {"name": "JET CRYSTALS", "tag": "THRUSTERS", "group": "skyborne",
	...
	"winglets": {"name": "WINGLETS", "tag": "GLIDER", "group": "skyborne",
		"color": Color(0.8, 1.0, 0.6), "layout": "Two long flat wings straight out to the sides.",
		"summary": "Mid-air double jump and a glide while held; your hits in the air do +50%.",
		"combo": "Glide over them with RAILGUN or ARBALEST."},
	"meteor_drop": {"name": "METEOR DROP", "tag": "AIR SLAM", "group": "skyborne",
	...
	"skylance": {"name": "SKYLANCE", "tag": "RIDEABLE SPEAR", "group": "skyborne",
	...
	"shard_mortar": {"name": "SHARD MORTAR", "tag": "CLUSTER ARTILLERY", "group": "fortress",
	...
	"crystal_wall": {"name": "CRYSTAL WALL", "tag": "INSTANT COVER", "group": "fortress",
		"color": Color(0.6, 0.45, 0.35), "layout": "A flat slab of five blades side by side in front.",
		"summary": "Raise a destructible crystal wall for 5s.",
		"combo": "Wall off, then ARC PYLON the other side."},
	"arc_pylon": {"name": "ARC PYLON", "tag": "TESLA TURRET", "group": "fortress",
		"color": Color(0.85, 1.0, 0.3), "layout": "Two tall forks, one each side, pointing up.",
		"summary": "Plant a pylon that zaps anyone within 8m for 8s.",
		"combo": "Hold a room with SPIKE CARPET."},
	"spike_carpet": {"name": "SPIKE CARPET", "tag": "GROUND TRAP", "group": "fortress",
	...
	"seeker_drone": {"name": "SEEKER DRONE", "tag": "COMPANION", "group": "fortress",
	...
	"crystal_saber": {"name": "CRYSTAL SABER", "tag": "MELEE / DEFLECT", "group": "brawler",
	...
	"shock_knuckle": {"name": "SHOCK KNUCKLE", "tag": "DASH PUNCH", "group": "brawler",
	...
	"buzzsaw": {"name": "BUZZSAW", "tag": "SPINNING BLADES", "group": "brawler",
	...
	"thorn_burst": {"name": "THORN BURST", "tag": "SHARD NOVA", "group": "brawler",
	...
	"mirage": {"name": "MIRAGE", "tag": "DECOYS", "group": "brawler",
	...
	# MARKSMAN / LONG RANGE
	"beam_lance": {"name": "BEAM LANCE", "tag": "CONTINUOUS LASER", "group": "marksman",
	...
	"piercer": {"name": "PIERCER", "tag": "PENETRATING RIFLE", "group": "marksman",
	...
	"arbalest": {"name": "ARBALEST", "tag": "HEAVY BOLT", "group": "marksman",
	...
	"ricochet_disc": {"name": "RICOCHET DISC", "tag": "BOUNCING DISC", "group": "marksman",
	...
	# MOMENTUM / SPEED
	"velocity_cannon": {"name": "VELOCITY CANNON", "tag": "SPEED-SCALED SHOT", "group": "momentum",
	...
	"sonic_boom": {"name": "SONIC BOOM", "tag": "SPEED SHOCKWAVE", "group": "momentum",
	...
	"slipstream": {"name": "SLIPSTREAM", "tag": "SPEED TRAIL", "group": "momentum",
