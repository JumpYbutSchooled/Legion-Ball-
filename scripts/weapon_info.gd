...
const WEAPONS := {
	...
	"gravity_well": {"built": true, "script": "res://scripts/weapons/gravity_well.gd",
		"usage": ["LMB  throw a singularity (lands, or pops open after 1s)", "Drags everyone within 15m into it for 2.5s", "Then it bursts", "6s cooldown"],
	...
	"time_dilator": {"built": true, "script": "res://scripts/weapons/time_dilator.gd",
		"usage": ["LMB  spread a 12m bubble round you for 4s", "Enemies inside are slowed", "Their shots crawl through it at half speed", "10s cooldown"],
	...
	"executioner": {"built": true, "script": "res://scripts/weapons/executioner.gd",
		"usage": ["LMB  lunge and chop everything in front (6m)", "Heavy hit, TRIPLE damage below 30% health", "1.2s cooldown"],
	...
	"blink_edge": {"built": true, "script": "res://scripts/weapons/blink_edge.gd",
		"usage": ["LMB  teleport 15m where you look (stops at walls)", "Keeps your speed, in the new direction", "Cuts everyone on the line", "2s cooldown"],
	...
	"crystal_wall": {"built": true, "script": "res://scripts/weapons/crystal_wall.gd",
		"usage": ["LMB  raise an 11m wall 6m ahead for 5s", "Blocks shots and players", "8s cooldown"],
	...
	"arc_pylon": {"built": true, "script": "res://scripts/weapons/arc_pylon.gd",
		"usage": ["LMB  plant a pylon at your feet for 8s", "Zaps whoever is nearest within 8m", "One at a time; 10s cooldown"],
	...
	"spike_carpet": {"built": true, "script": "res://scripts/weapons/spike_carpet.gd",
		"usage": ["LMB  lay a 20m line of spikes ahead for 6s", "Anyone crossing it is cut and slowed", "7s cooldown"],
	...
	"crystal_saber": {"built": true, "script": "res://scripts/weapons/crystal_saber.gd",
		"usage": ["LMB  swing: cuts everything in a wide arc (5.5m)", "During the swing, shots that hit you are DEFLECTED back", "1s cooldown"],
	...
	"thorn_burst": {"built": true, "script": "res://scripts/weapons/thorn_burst.gd",
		"usage": ["HOLD LMB  charge (0.8s), RELEASE  burst", "A ring of shards all round you (12m)", "Longer charge, harder shards"],
	...
	"mirage": {"built": true, "script": "res://scripts/weapons/mirage.gd",
		"usage": ["LMB  two decoys in your colour roll off for 5s", "Enemy locks and missiles can jump to them", "Any hit pops a decoy", "12s cooldown"],
	...
	"sonic_boom": {"built": true, "script": "res://scripts/weapons/sonic_boom.gd",
		"usage": ["LMB at 45 m/s+  fire your speed off as a shockwave", "Hits everyone in a 25m cone ahead", "You slow right down"],
	...
	"slipstream": {"built": true, "script": "res://scripts/weapons/slipstream.gd",
		"usage": ["HOLD LMB  lay a glowing trail behind you (4s)", "Riding it pushes you faster", "Anyone crossing it gets cut"],
