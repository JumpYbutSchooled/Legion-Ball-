...
## Locks the target nearest the crosshair, at any range, walls or not; press to tag
## them: you see a sigil and a beam of light over them through walls for 6s (only you),
## and they're MARKED for 3s (1.5x damage from everything).
