...
## front. Press to raise a 30m x 14m crystal wall 12m ahead, facing you: solid cover against
...
func _fire(_pressed: bool, just: bool, _released: bool, _hit: Dictionary, _delta: float) -> void:
	...
	var spot := ball().global_position + flat * 12.0
	...
	spawn("res://scripts/weapons/crystal_wall_node.gd", {
		"position": ground["position"] + Vector3.UP * 7.0, "facing": -flat, "color": color,
